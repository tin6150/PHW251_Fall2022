...
## errr... it still say chr... Sn50
testing_factor <- data.frame(
  county = c("Alameda","Contra Costa","Marin"),
  total_tests = c(500,745,832),
  pos_tests = c(43, 32, 30),
  stringsAsFactors = TRUE          ## now it shows up as factor, so FALSE is default?  ##Sn50
)
str(testing_factor)
...
testing_row_name <- data.frame(
  ...
  total_tests = c(500,745,832),
  pos_tests = c(43, 32, 30),
  row.names = "county"                     ## this no longer treated as a general column/variable 
)

str(testing_row_name)  ##Sn50
...
testing_reordered_rows <- testing[order(testing$county),]  ## note position of comma!
