...
datatable(std_tbl,
          ...
          formatStyle(2:4,backgroundColor = styleInterval(c(50),c('white','yellow')))

##Sn50 the c(500) has to deal with value in the cell... a conditional...   i changed to c(50) for test.
```
